...
export default class MenuAfricana extends React.Component {
    ...
    return (
      <View style={styles.menu}>
        ...
        <View>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button2} onPress={() => this.props.navigation.push('PartidosAfricana')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button1} onPress={() => this.props.navigation.push('StadisticsAfricana')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button3} onPress={() => this.props.navigation.push('MarketAfricana')}>
