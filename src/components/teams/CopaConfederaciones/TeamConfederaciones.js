...
export default class TeamConfederaciones extends Component {
  ...
  componentDidMount() {
    const itemsRef = firebase.database().ref('CopaConfederaciones/Equipos');
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={styles.buttonContainer} onPress={() => this.props.navigation.push('PartidosConfederaciones')}>
