...
export default class TeamAmerica extends Component {
  ...
  componentDidMount() {
    const itemsRef = firebase.database().ref('CopaAmerica/Equipos');
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={styles.buttonContainer} onPress={() => this.props.navigation.push('PartidosAmerica')}>
