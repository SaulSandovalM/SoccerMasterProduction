...
export default class MenuFemenil extends React.Component {
    ...
    return (
      <View style={styles.menu}>
        ...
        <View>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button2} onPress={() => this.props.navigation.push('PartidosFemenil')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button1} onPress={() => this.props.navigation.push('StadisticsFemenil')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button3} onPress={() => this.props.navigation.push('MarketFemenil')}>
