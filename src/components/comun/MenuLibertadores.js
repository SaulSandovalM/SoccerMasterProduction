...
export default class MenuLibertadores extends React.Component {
    ...
    return (
      <View style={styles.menu}>
        ...
        <View>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button2} onPress={() => this.props.navigation.push('PartidosLibertadores')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button1} onPress={() => this.props.navigation.push('StadisticsLibertadores')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button3} onPress={() => this.props.navigation.push('MarketLibertadores')}>
