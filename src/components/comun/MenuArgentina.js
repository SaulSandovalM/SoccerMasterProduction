...
export default class MenuArgentina extends React.Component {
    ...
    return (
      <View style={styles.menu}>
        ...
        <View>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button2} onPress={() => this.props.navigation.push('PartidosArgentina')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button1} onPress={() => this.props.navigation.push('StadisticsArgentina')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button3} onPress={() => this.props.navigation.push('MarketArgentina')}>
