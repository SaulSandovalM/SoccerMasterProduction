...
export default class TeamFemenil extends Component {
  ...
  componentDidMount() {
    const itemsRef = firebase.database().ref('CopaFemenil/Equipos');
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={styles.buttonContainer} onPress={() => this.props.navigation.push('PartidosFemenil')}>
