                        ...
                        <Content>
                            ...
                            >
                                <View style={styles.cardStyle}>
                                    ...
                                    <Text onPress={() => this.props.navigation.push('Partido')}
                                          style={styles.textTeam}> TIJUANA <Text style={styles.num}> 2 </Text></Text>
                            ...
                            >
                                <View style={styles.cardStyle}>
                                    ...
                                    <Text onPress={() => this.props.navigation.push('Partido')}
                                          style={styles.textTeam}> AMÉRICA <Text style={styles.num}> 2 </Text></Text>
                            ...
                            >
                                <View style={styles.cardStyle}>
                                    ...
                                    <Text onPress={() => this.props.navigation.push('Partido')}
                                          style={styles.textTeam}> SANTOS <Text style={styles.num}> 2 </Text></Text>
