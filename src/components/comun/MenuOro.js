...
export default class MenuOro extends React.Component {
    ...
    return (
      <View style={styles.menu}>
        ...
        <View>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button2} onPress={() => this.props.navigation.push('PartidosOro')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button1} onPress={() => this.props.navigation.push('StadisticsOro')}>
          ...
          <View>
            <TouchableHighlight>
              <Button style={styles.Button3} onPress={() => this.props.navigation.push('MarketOro')}>
