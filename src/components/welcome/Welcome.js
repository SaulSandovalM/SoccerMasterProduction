                ...
                <View style={styles.pageStyle} key="2">
                    <ImageBackground source={img2} style={styles.viewPager}>
                        <Text style={styles.textStyle}>Navega {'\n'}{'\n'}
                            <Text style={styles.textStyle2}>A través de las estadistícas de tus equipos y jugadores
                                favoritos.</Text>
                        </Text>
                    </ImageBackground>
                </View>
                ...
                <View style={styles.pageStyle} key="3">
                    <ImageBackground source={img3} style={styles.viewPager}>
                        <Text style={styles.textStyle4}>Disfruta {'\n'}{'\n'}
                            <Text style={styles.textStyle2}>De la buena experiencia y eficacia de esta
                                plataforma.</Text>
                        </Text>
